...
export async function createValidator(inputData: ICreatePartner, repository: Repository<UserEntity>) {
...
async function isUniqueLogin(id: number, login: string, repository: Repository<UserEntity>) {
...
async function isUniqueEmail(id: number, email: string, repository: Repository<UserEntity>) {
...
async function isUniqueReferId(id: number, referId: string, repository: Repository<UserEntity>) {
...
async function isValidLeader(id: number, repository: Repository<UserEntity>) {
